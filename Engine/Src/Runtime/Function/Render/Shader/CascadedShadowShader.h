...
namespace photon 
{
	...
	struct CascadedShadowShaderBlob : public ShaderBlob
	{
	...
	class CascadedShadowShader : public Shader
	{
	public:
		CascadedShadowShader(const std::wstring& filepath)
			: Shader(filepath){
	...
	private:
		...
		std::unordered_map<std::string, CascadedShadowShaderBlob> m_VariantToShaderBlob;
	};
