...
namespace photon
{
	...
	struct DebugDrawLightShaderBlob : public ShaderBlob
	{
	...
	class DebugDrawLightShader : public Shader
	{
	public:
		DebugDrawLightShader(const std::wstring& filepath)
			: Shader(filepath) {
	...
	private:
		...
		std::unordered_map<std::string, DebugDrawLightShaderBlob> m_VariantToShaderBlob;
	};
